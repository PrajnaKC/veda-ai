...
exports.createAssignmentPdf = createAssignmentPdf;
const jspdf_1 = require("jspdf");
function createAssignmentPdf(assignment) {
    var _a;
    const doc = new jspdf_1.jsPDF({ unit: "pt", format: "a4" });
    const margin = 48;
    let y = margin;
    const write = (text, size = 11, lineGap = 18) => {
    ...
    (_a = assignment.generatedPaper) === null || _a === void 0 ? void 0 : _a.sections.forEach((section, sectionIndex) => {
        doc.setFont("helvetica", "bold");
        ...
        section.questions.forEach((question, questionIndex) => {
            write(`${questionIndex + 1}. [${question.difficulty}] ${question.text} [${question.marks} Marks]`, 11, 16);
        });
    });
